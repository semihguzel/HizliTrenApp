namespace HızlıTrenApp.UI
{
	partial class frmKoltukSecimi
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpYolcuBilgileri.Controls.Add(this.txtEmail);
			this.grpYolcuBilgileri.Controls.Add(this.txtTcNo);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel7);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel6);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel4);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel5);
			this.grpYolcuBilgileri.Controls.Add(this.lbl);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel3);
			this.grpYolcuBilgileri.Controls.Add(this.txtSoyad);
			this.grpYolcuBilgileri.Controls.Add(this.metroLabel2);
			...
			this.grpYolcuBilgileri.Size = new System.Drawing.Size(728, 179);
			...
			this.metroLabel4.Text = "Doğum Tarihi";
			// 
			// metroLabel5
			// 
			...
			this.label1.Location = new System.Drawing.Point(434, 225);
